...
public class BM25FScoring {
	...
	public static void main(String[] args) {
		String[] files = {
				...
				"The Zwinger (German: Dresdner Zwinger, IPA: [ˈdʁeːzdnɐ ˈt͡svɪŋɐ]) is a palace in the eastern German city of Dresden, built in Rococo style and designed by court architect Matthäus Daniel Pöppelmann. It served as the orangery, exhibition gallery and festival arena of the Dresden Court. The location was formerly part of the Dresden fortress of which the outer wall is conserved. The name derives from the German word Zwinger (an enclosed killing ground in front of a castle or city gate); it was for the cannons that were placed between the outer wall and the major wall. The Zwinger was not enclosed until the Neoclassical building by Gottfried Semper called the Semper Gallery was built on its northern side. Today, the Zwinger is a museum complex that contains the Gemäldegalerie Alte Meister (Old Masters Picture Gallery), the Dresden Porcelain Collection (Porzellansammlung) and the Mathematisch-Physikalischer Salon (Royal Cabinet of Mathematical and Physical Instruments).",
